...
from utils.vision_transformer import Attention
from utils.swin_transformer import WindowAttention
...
def build_model(name, args):
    ...
    """
    model = timm.create_model(name, pretrained=True, drop_path_rate=args.drop_path)
